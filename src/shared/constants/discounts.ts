...
export const DISCOUNTS: readonly Discount[] = [
  ...
  { id: 'young', name: 'Joven', order: 6, percentage: 20, incompatibleWith: ['child', 'junior', 'sub25'] },
  { id: 'child', name: 'Niño', order: 7, percentage: 80, categoryRestriction: 'premium-only', incompatibleWith: ['junior', 'sub25', 'young', 'family'] },
  { id: 'junior', name: 'Junior', order: 8, percentage: 70, categoryRestriction: 'premium-only', incompatibleWith: ['family', 'sub25', 'child', 'young'] },
  { id: 'sub25', name: 'Sub-25', order: 9, percentage: 50, incompatibleWith: ['junior', 'child', 'young', 'family'] },
