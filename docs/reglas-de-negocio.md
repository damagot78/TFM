...
**Longitud del PIN — decisión consciente:** se evaluó subir de 4 dígitos numéricos a 6 (mitigación proporcional a no tener rate limiting), pero se descarta para el v1: uso interno, sin datos sensibles detrás, y el personal lo teclea muchas veces al día — se prioriza la rapidez de uso sobre una fuerza bruta más difícil. Vía de escalado ya decidida si en el futuro hiciera falta más seguridad: pasar a 2 letras + 4 dígitos (mantiene un PIN corto y memorizable, pero amplía notablemente el espacio de combinaciones).
